...
const features = [
  {
    ...
    colorClass: 'from-orange-500/20 to-amber-500/20 text-accent group-hover:border-accent/40 group-hover:shadow-accent/10',
    iconBg: 'bg-accent/10 text-accent',
    badgeColor: 'bg-accent/5 text-accent border-accent/20'
  },
  {
    icon: FiAward,
    ...
    colorClass: 'from-blue-500/20 to-primary/20 text-primary group-hover:border-primary/40 group-hover:shadow-primary/10',
  ...
  },
  {
    ...
    colorClass: 'from-teal-500/20 to-secondary/20 text-secondary group-hover:border-secondary/40 group-hover:shadow-secondary/10',
    iconBg: 'bg-secondary/10 text-secondary',
    badgeColor: 'bg-secondary/5 text-secondary border-secondary/20'
  },
  {
    icon: FiFolder,
...
export default function WhyChooseUs() {
  ...
  return (
    <section id="services" className="relative py-28 overflow-hidden bg-slate-50/50 dark:bg-slate-900/10">
      {/* Background shape */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-tr from-slate-100 dark:from-slate-800/40 to-transparent blur-3xl -z-10 opacity-60" />
          ...
          {features.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="group relative flex flex-col justify-between rounded-2xl border border-border/80 bg-card p-6.5 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-slate-350 dark:hover:border-slate-700"
              >
